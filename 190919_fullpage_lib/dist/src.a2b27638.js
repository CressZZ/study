...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/fullpage.js/vendors/easings.min.js":[function(require,module,exports) {
...
},{}],"node_modules/fullpage.js/vendors/scrolloverflow.min.js":[function(require,module,exports) {
var define;
/**
...
},{"process":"../../../.nvm/versions/node/v10.16.0/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/fullpage.js/dist/fullpage.js":[function(require,module,exports) {
var define;
/*!
 * fullPage 3.0.7
 * https://github.com/alvarotrigo/fullPage.js
...
require("fullpage.js/vendors/easings.min.js");
...
window.test = new _fullpage.default('#fullpage', {
  ...
  scrollingSpeed: 700,
  // 스크롤 속도
  sectionsColor: ['#333', '#bbb', '', '#333'],
  // 섹션 배경색
  easing: 'easeInOutCubic',
  // 섹션 이동 이징 효과
  loopTop: false,
  // 첫번째 섹션에서 위로 스크롤 시 마지막 섹션으로 이동 여부
  loopBottom: false,
  // 마지막 섹션에서 아래로 스크롤 시 첫번째 섹션으로 이동 여부
  loopHorizontal: true,
  // 슬라이드 좌우 루프 여부
  fitToSection: true,
  // 스크롤바로 이동시 섹션 중간에 멈춤 가능 여부
  fitToSectionDelay: 1000,
  // fitToSection 동작 딜레이
  scrollBar: false,
  // 스크롤바 표시 여부
  ...
  // 섹션 상단 패딩
  normalScrollElements: null,
  // 섹션 내 기본 스크롤 동작 요소 ('.map, .banner')
  bigSectionsDestination: null,
  // 뷰포트보다 큰 섹션으로 스크롤 하는 방법 정의 (top | bottom | null )
  keyboardScrolling: true,
  // 키보드 스크롤 가능 여부
  continuousHorizontal: false,
  // 슬라이드 맨 뒤에서 다음 버튼 클릭 시 처음으로 이동 (https://gumroad.com/l/fullpageContinuousHorizontal)
  scrollHorizontally: false,
  // 슬라이드가 있는 섹션에서 스크롤 시 슬라이드가 끝나면 섹션 이동 (https://gumroad.com/l/fullpageScrollHorizontally)
  dragAndMove: false,
  // 드래그 이동 (https://gumroad.com/l/fullpageDragAndMove)
  offsetSections: false,
  // 섹션 보여주는 비율 및 정렬 기능 사용 여부 (https://gumroad.com/l/fullpageOffsetSections)
  fadingEffect: true,
  // 섹션 및 슬라이드 이동시 페이드 효과 (https://gumroad.com/l/fullpageFadingEffect)
  animateAnchor: true,
  // 주소에 앵커가 있을 경우 이동 여부
  recordHistory: true,
  // 뒤로가기 히스토리 저장 여부
  ...
  // scrollOverflow 사용 시 섹션 내 컨텐츠 상단으로 고정 여부 (https://gumroad.com/l/fullpageScrolloverflowReset)
  ...
  responsiveSlides: false,
  // 일반 스크롤로 동작할 때 슬라이드 펼침 여부 (https://gumroad.com/l/fullpageResponsiveSlides)
  parallax: false,
  // 패럴렉스 효과 (https://gumroad.com/l/fullpageParallax)
  parallaxOptions: {
    type: 'reveal',
    percentage: 62,
    property: 'translate'
  ...
  onLeave: function onLeave(origin) {// 섹션을 떠날 때
  ...
  afterRender: function afterRender() {// 섹션 구조가 생성 된 후
    // console.log('afterRender');
  },
  afterResize: function afterResize() {// 브라우저 리사이즈될 때
    // console.log('afterResize', width, height);
  },
  afterResponsive: function afterResponsive() {// 페이지 모드와 일반 스크롤 모드로 전환 될 때
  ...
  onSlideLeave: function onSlideLeave() {// 슬라이드를 떠날 때
    // console.log('onSlideLeave', section, origin, destination, direction);
  }
});
},{"fullpage.js/vendors/easings.min.js":"node_modules/fullpage.js/vendors/easings.min.js","fullpage.js/vendors/scrolloverflow.min.js":"node_modules/fullpage.js/vendors/scrolloverflow.min.js","jquery":"node_modules/jquery/dist/jquery.js","fullpage.js":"node_modules/fullpage.js/dist/fullpage.js"}],"../../../.nvm/versions/node/v10.16.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
